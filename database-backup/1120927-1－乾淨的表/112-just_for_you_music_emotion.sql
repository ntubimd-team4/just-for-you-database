...
--
-- Table structure for table `music_emotion`
--

DROP TABLE IF EXISTS `music_emotion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `music_emotion` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '流水號',
  `m_id` int NOT NULL COMMENT '對應music表的m_id',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='音樂情緒表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `music_emotion`
--

LOCK TABLES `music_emotion` WRITE;
/*!40000 ALTER TABLE `music_emotion` DISABLE KEYS */;
/*!40000 ALTER TABLE `music_emotion` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-09-27  9:50:12
